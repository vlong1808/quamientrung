...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	<li><a href="index.php?com=product&act=man_cat<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>"><span>Danh sách nhà sản xuất</span></a></li>
        	<?php if($_GET['key']!=''){ ?>
...
<div class="widget">
  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
      ...
      <tr>
        ...
        <td width="200" class="none"><?=get_main_danhmuc()?></td>    
        <td width="200" class="none"><?=get_main_list()?></td>    
        <td class="sortCol"><div>Tên đơn vị<span></span></div></td>
