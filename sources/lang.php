...
@define ('_nhaphoten','Vui lòng nhập Xin nhập Họ tên');
@define ('_nhapdiachi','Vui lòng nhập Xin nhập Địa chỉ');
@define ('_nhapsodienthoai','Vui lòng nhập Xin nhập Số điện thoại');
@define ('_khonghople','Vui lòng nhập Số điện thoại không hợp lệ');
@define ('_emailkhonghople','Email không hợp lệ');
@define ('_nhapchude','Vui lòng nhập Xin nhập Chủ đề');
@define ('_nhapnoidung','Vui lòng nhập Xin nhập Nội dung');
@define ('_gui','Gửi');
@define ('_nhaplai','Vui lòng nhập Nhập lại');
