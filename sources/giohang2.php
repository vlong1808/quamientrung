<?php  if(!defined('_source')) die("Error");	
	...
	if(isset($_POST['hoten'])){	
		...
		if(mysql_query($sql))
		{
				...
				{		
					...
					*=====================================*/
					...
					$mail->CharSet = "utf-8";
					    ...
					    $body .= '<tr>
								<td colspan="2"><img src="http://'.$config_url.'/'._upload_hinhanh_l.$row_banner['photo'].'" /></td>
								</tr>';
						$body .= '<tr style="font-weight: bold;font-size: 20px;">
									<td colspan="2">THỰC PHẨM AN TOÀN</td>
								</tr>';
						$body .= '<tr>
        	...
        	<td colspan="2">* Đây là thư trả lời tự động,vui lòng không liên hệ lại bằng mail này.Cảm ơn.</td>
        </tr>';
				   $body.='</table>';
				   #------------Chi tiết đơn hàng---------------------
